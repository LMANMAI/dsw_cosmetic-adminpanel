/**
 * Catálogo base (semilla) — copia de beautyapp/src/data/catalogo.ts.
 *
 * Se usa solo para el botón "Sembrar catálogo base" del panel: sube estas
 * categorías y servicios a Firestore cuando la base está vacía. A partir de
 * ahí, la fuente de verdad son las colecciones `categorias` y
 * `catalogo_servicios`, que se administran desde /catalogo.
 *
 * Si cambian las categorías base en la app móvil, actualizar este archivo.
 */
import type { Categoria, CategoriaSlug, ServicioCatalogo } from "../types";
